...
- [编程语言](languages/index.md) — 语法、特性
  ...
  - [Node.js](languages/nodejs/index.md)
    - [Node.js 模块系统：ESM 和 CommonJS 到底哪里不一样](languages/nodejs/esm-cjs-modules.md) — 2026-07-04
...
- [架构设计](architecture/index.md) — 系统设计、技术方案
  - [设计模式：Rust 视角](architecture/design-patterns/index.md) — 2026-07-17（7/23）
...
- [源码阅读](source-read/index.md) — 开源项目的源码分析
  - [MetaGPT 源码阅读系列](source-read/meta_gpt/) — 2026-07-17（5 篇）
