...
- [技术笔记](tech/index.md) — 框架、工具
  ...
  - [Pandas 自己算指标 vs TA-Lib：什么时候该轻一点，什么时候该专业一点](tech/pandas-vs-ta-lib-guide.md) — 2026-05-31
  - [TA-Lib Python 指南：在 Python 里快速用上经典技术分析库](tech/ta-lib-python-guide.md) — 2026-05-31
  - [HTML-Anything：让 AI 直接产出可发布的单文件 HTML](tech/html-anything-guide.md) — 2026-05-31
