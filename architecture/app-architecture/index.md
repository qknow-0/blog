...
| # | 主题 | 回答什么问题 |
|---|------|-------------|
| [14](14-entity-value-aggregate.md) | 实体、值对象、聚合 | 什么该有 ID，什么该不可变 |
| [15](15-aggregate-root.md) | 聚合根 | 一致性边界怎么划 |
| [16](16-bounded-context.md) | 限界上下文 | 同一个词为什么在不同地方意思不同 |
| [17](17-acl-context-mapping.md) | 防腐层与上下文映射 | 依赖别人之前先包一层，值不值 |

### 六、进阶与反方 ✅

| # | 主题 | 回答什么问题 |
|---|------|-------------|
| [18](18-cqrs-event-sourcing.md) | CQRS 与事件溯源 | 把状态变成日志 |
| [19](19-when-overkill.md) | 反方 | 什么时候这些全是过度设计 |
